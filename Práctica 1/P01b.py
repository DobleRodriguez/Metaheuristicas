...
def read_data(set_name):
    data = pd.read_csv(pl.Path(__file__).parent /
    f"Instancias y Tablas PAR 2019-20/{set_name}_set.dat", header=None)
    const_10 = pd.read_csv(pl.Path(__file__).parent /
    f"Instancias y Tablas PAR 2019-20/{set_name}_set_const_10.const", header=None) 
    const_20 = pd.read_csv(pl.Path(__file__).parent /
    f"Instancias y Tablas PAR 2019-20/{set_name}_set_const_20.const", header=None) 
